...
class FlowView:
    """
    A view of Flow metadata stored in the merak API.

    This object is designed to be an immutable view of the data stored in the merak
    ...
    project_name: str
    core_version: str
    storage: merak.storage.Storage
    name: str
    flow_group_labels: List[str]

    @property
    def flow(self) -> "merak.Flow":
        """
    ...
    def _from_flow_data(cls, flow_data: dict, **kwargs: Any) -> "FlowView":
        ...
        This method deserializes objects into their merak types.
