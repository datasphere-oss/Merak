...
from merak.engine.state import Scheduled, State
from merak.engine.result import Result, NoResultType
...
class TaskRunView:
    """
    A view of Task Run data stored in the merak API.

    Provides lazy loading of task run return values from merak `Result` locations.
