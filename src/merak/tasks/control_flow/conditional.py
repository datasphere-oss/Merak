...
class Merge(Task):
    def __init__(self, **kwargs) -> None:
        ...
        kwargs.setdefault("trigger", merak.triggers.not_all_skipped)
...
def switch(condition: Task, cases: Dict[Any, Task], mapped: bool = False) -> None:
    ...
    Raises:
        - merakWarning: if any of the tasks in "cases" have upstream dependencies,
    ...
    with merak.tags("switch"):
        for value, task in cases.items():
            task = merak.utilities.tasks.as_task(task)
