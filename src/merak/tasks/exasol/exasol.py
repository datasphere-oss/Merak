...
class ExasolExecute(Task):
    ...
    Args:
        ...
        - dsn_secret (str, optional): the name of the merak Secret that stores the Exasol
            dsn connection string (server:port)
        - user_secret (str, optional): the name of the merak Secret that stores the Exasol
            user name
        - password_secret (str, optional): the name of the merak Secret that stores the Exasol
            password
