...
from merak.tasks.shell import ShellTask
from merak.utilities.tasks import defaults_from_attrs
from merak.backend.artifacts import create_markdown_artifact
...
class DbtShellTask(ShellTask):
    ...
    [ShellTask](https://docs.merak.io/api/latest/tasks/shell.html#shelltask).
    ...
    Example:
        ...
        from merak.tasks.dbt import DbtShellTask
    ...
    def run(
        ...
        Raises:
            - merak.engine.signals.FAIL: if command has an exit code other
                than 0
        """
...
class DbtCloudRunJob(Task):
    ...
    Running this task will generate a markdown artifact viewable in the merak UI. The artifact
    ...
    Raises:
        - merak.engine.signals.FAIL: whether there's a HTTP status code != 200
