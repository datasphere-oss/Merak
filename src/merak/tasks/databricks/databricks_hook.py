...
USER_AGENT_HEADER = {"user-agent": "merak-{v}".format(v=merak.__version__)}
...
class DatabricksHook:
    ...
    def _do_api_call(self, endpoint_info, json):
        ...
        if method == "GET":
            ...
            raise merakException("Unexpected HTTP Method: " + method)
