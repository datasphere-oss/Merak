...
class DatastoreRegisterBlobContainer(Task):
    ...
    Args:
        ...
        - azure_credentials_secret (str, optinonal): The name of the merak Secret that stores
    ...
    def run(
        ...
        Args:
            ...
            - azure_credentials_secret (str, optinonal): The name of the merak Secret that
