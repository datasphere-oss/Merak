...
class PushbulletTask(Task):
    ...
    this task to function properly, you must have the `"PUSHBULLET_TOKEN"` merak Secret set.
    ...
    def run(self, msg: str = None, access_token: str = None) -> None:
        ...
        Args:
            - msg (str): The message you want sent to your phone; defaults to the one provided
                at initialization
            - access_token (str): a Pushbullet access token, provided with a merak secret.
        ...
        try:
            ...
            raise ImportError(
                "Using pushbullet tasks requires merak to be installed with the 'pushbullet' extra."
            ) from exc
