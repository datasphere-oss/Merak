...
from merak.tasks.kubernetes.pod import ReadNamespacedPodLogs
...
class CreateNamespacedJob(Task):
    ...
    1. Attempt to use a merak Secret that contains a Kubernetes API Key. If
    ...
    Args:
        ...
        - kubernetes_api_key_secret (str, optional): the name of the merak Secret
...
class RunNamespacedJob(Task):
    ...
    def run(
        ...
        context_copy = merak.context.copy()

        def initialize_thread(context):
            merak.context.update(context)
