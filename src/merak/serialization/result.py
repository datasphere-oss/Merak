...
from merak.engine import result, results
from merak.tasks.secrets import SecretBase
...
class merakResultSchema(ObjectSchema):
    class Meta:
        object_class = results.merakResult
