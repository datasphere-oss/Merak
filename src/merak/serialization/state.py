...
from merak.serialization.result import StateResultSchema
...
class MetaStateSchema(BaseStateSchema):
    state = fields.Nested("merak.serialization.state.StateSchema", allow_none=True)
...
class MappedSchema(SuccessSchema):
    ...
    map_states = fields.Nested("merak.serialization.state.StateSchema", many=True)
