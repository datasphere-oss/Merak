...
from merak.utilities.serialization import JSONCompatible, ObjectSchema, OneOfSchema
...
class DockerSchema(BaseStorageSchema):
    ...
    stored_as_script = fields.Bool(allow_none=True)
    merak_version = fields.String(allow_none=False)
