...
class KubernetesRun(RunConfig):
    ...
    or an in-memory object (which will be stored along with the flow in merak
    ...
    Use a local job template, which is stored along with the Flow in merak
    Cloud/Server:
    ...
    `/merak/src/merak/agent/kubernetes/job_template.yaml` in the repository,
