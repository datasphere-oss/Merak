...
from merak.utilities.git import TemporaryGitRepo
...
class Git(Storage):
    ...
    - Call `merak register -f flow.py` to register this flow with Git storage.
    ...
    Args:
        ...
        - git_token_secret_name (str, optional): The name of the merak Secret containing
        ...
        - git_clone_url_secret_name (str, optional): the name of the merak Secret specifying
