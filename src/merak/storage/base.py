...
from merak.storage import _healthcheck
from merak.utilities import logging as merak_logging
...
class Storage(metaclass=ABCMeta):
    ...
    Args:
        ...
        - secrets (List[str], optional): a list of merak Secrets which will be used to
            populate `merak.context` for each flow run.  Used primarily for providing
    ...
    def logger(self) -> "logging.Logger":
        ...
        merak logger.
        """
        return merak_logging.get_logger(type(self).__name__)
    ...
    def serialize(self) -> dict:
        ...
        """
        schema = merak.serialization.storage.StorageSchema()
