...
from merak.engine.results import AzureResult
...
class Azure(Storage):
    ...
    Args:
        ...
        - connection_string_secret (str, optional): the name of a merak secret
