"""
Results represent merak Task inputs and outputs.  In particular, anytime a
...
that has yet to run, merak also provides a `NoResult` object representing the
...
from merak.engine.serializers import PickleSerializer, Serializer
...
class Result:
    """
    A representation of the result of a merak task; this class contains
    ...
    def default_location(self) -> str:
        ...
        location = f"{date}/{uuid.uuid4()}.merak_result"
        return location
    ...
    def exists(self, location: str, **kwargs: Any) -> bool:
        ...
        raise ResultNotImplementedError(
            ...
            "see https://docs.merak.io/core/concepts/results.html"
        )
