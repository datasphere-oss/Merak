...
from merak.triggers import all_successful, all_failed
...
from merak.engine.state import Mapped

if TYPE_CHECKING:
    from merak.engine import state  # noqa
    from merak import core  # noqa
...
def manual_only(upstream_states: Dict["core.Edge", "state.State"]) -> bool:
    ...
    the "resume" keyword is found in the merak context, which happens
