...
import merak
from merak.engine.serializers import DateTimeSerializer
import merak.engine.signals
import merak.triggers
from merak.core.task import Task, NoDefault
from merak.engine.results import merakResult
...
class Parameter(Task):
    ...
    def __init__(
        ...
        super().__init__(
            name=name, slug=name, tags=tags, result=merakResult(), checkpoint=True
        )
    ...
    def serialize(self) -> Dict[str, Any]:
        ...
        """
        return merak.serialization.task.ParameterSchema().dump(self)
...
class DateTimeParameter(Parameter):
    ...
    def __init__(
        ...
        self.result = merakResult(serializer=DateTimeSerializer())
