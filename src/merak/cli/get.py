...
def get():
    """
    Get commands that refer to querying merak API metadata.
    ...
    \b
        $ merak get flows --project New-Proj --all-versions
        NAME        VERSION   PROJECT NAME   AGE
        Test-Flow   2         New-Proj       22 hours ago
        Test-Flow   1         New-Proj       1 month ago

    \b
        $ merak get tasks --flow-name Test-Flow
...
def flows(name, version, project, limit, all_versions):
    """
    Query information regarding your merak flows.
...
def projects(name):
    """
    Query information regarding your merak projects.
...
def flow_runs(limit, flow, project, started):
    """
    Query information regarding merak flow runs.
...
def tasks(name, flow_name, flow_version, project, limit):
    """
    Query information regarding your merak tasks.
