...
def describe():
    """
    Output information about different merak objects.

    \b
    Usage:
        $ merak describe [OBJECT]
    ...
    \b
    Examples:
        $ merak describe flows --name My-Flow --version 2 -o json
        {
            "name": "My-Flow",
            "version": 2,
            "project": {
            ...
            "storage": {
                "type": "Docker",
                "flows": {
                    "My-Flow": "/root/.merak/My-Flow.merak"
                },
...
def tasks(name, version, project, output):
    """
    Describe tasks from a merak flow. This command is similar to `merak describe flow`
