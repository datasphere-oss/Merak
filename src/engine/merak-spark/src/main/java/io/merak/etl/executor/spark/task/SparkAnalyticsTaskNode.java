...
public class SparkAnalyticsTaskNode implements TaskNode
{
    ...
    public SparkAnalyticsTaskNode(final AnalyticsNode analyticsNode, final Predictor predictor, final String sampleDataQuery, final TranslatorState translatorState) {
