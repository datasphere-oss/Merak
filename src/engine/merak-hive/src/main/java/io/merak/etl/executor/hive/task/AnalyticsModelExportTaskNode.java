...
public class AnalyticsModelExportTaskNode implements TaskNode
{
    ...
    public AnalyticsModelExportTaskNode(final AnalyticsModelExportNode exportNode, final String parentNode, final TranslatorState sparkTranslatorState) {
